...
class Home extends Component {
    ...
    register() {
        ...
        var passwordInput = document.getElementById("formRegisterPassword").value;
        var phoneNumberInput = document.getElementById("formRegisterPhoneNumber").value;
        var genderInput =  "Male"//document.getElementById("formRegisterGender");

        if( nameInput != null && emailInput != null && passwordInput != null && phoneNumberInput != null && genderInput != null)
            ClientService.register(nameInput, emailInput, passwordInput, genderInput, phoneNumberInput).then( (response) => {
                console.log(response);
                        ...
                        <Card className={classes.root} variant="outlined">
                            <CardContent>
                                ...
                                <Form className={classes.form}>
                                    ...
                                    <Form.Group className="mb-3" controlId="formRegisterGenderGroup">
                                        <Dropdown id="dropdown-basic">
                                            <Dropdown.Toggle variant="Light" id="formRegisterGender">
                                                Sex
                                            </Dropdown.Toggle>
