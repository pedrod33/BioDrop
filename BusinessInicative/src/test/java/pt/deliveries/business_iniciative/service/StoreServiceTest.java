...
public class StoreServiceTest {
    ...
    public void setUp() {
        ...
        when(repository.findByName(store1.getName())).thenReturn(store1);
        when(repository.findByName("wrong_name")).thenReturn(null);
        when(repository.findByAddress(store1.getAddress())).thenReturn(store1);
    ...
    public void whenValidName_thenStoreShouldBeFound() {
        String name = "store1";
        Store found = service.findByName(name);
    ...
    public void whenInvalidName_thenStoreShouldNotBeFound() {
        ...
        Store notFound = service.findByName(name);
    ...
    public void whenValidAddress_thenStoreShouldBeFound() {
        ...
        Store found = service.findByAddress(address);
    ...
    public void whenInvalidAddress_thenStoreShouldNotBeFound() {
        ...
        Store notFound = service.findByAddress(address);
